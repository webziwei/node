...
function getMovie(url, callback) {
    request(url, function (err, response, body) {
        if (!err && response.statusCode == 200) {
            ...
            var content = $(".ui-slide-content li.ui-slide-item");//输入标签名定位到查找提取的数据
            var content1 = $(".ui-slide-content li.ui-slide-item ul li.poster img");
...
getMovie("http://sc.chinaz.com/tupian/xingkongtupian.html");
